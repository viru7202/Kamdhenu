...
export default function CreateReportingDatewise() {
          ...
          <div className="row">
            ...
            <div className="col-lg-12 col-sm-12">
              <div className="content-page-header">
                <h5>Create Reporting Datewise</h5>
              </div>
              ...
              <div className="row">
                ...
                <div className="btn-path mt-4">
                  <Link to="/reporting-datewise" className="btn btn-cancel me-3">
                    Back
                  </Link>
