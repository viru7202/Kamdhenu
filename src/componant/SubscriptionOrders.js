                    ...
                    <div className="content">
                        <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Subscription Orders</li>
                            </ol>
                        </nav>
                        <div className="content-page-header content-page-headersplit">
                            <h5>Subscription Orders </h5>
                        </div>
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="list-btn">
                                <ul>
                                    <li>
                                        <Link to={"/Create-Subscription-Orders"} className="btn btn-primary">
                                            <i className="fa fa-plus me-2"></i>POS
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <table className="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="table-actions d-flex">
                                                        <Link className="delete-table me-2" to={'/edit-subscriptionorders/1'}>
                                                            <i className="fas fa-edit"></i>
                                                        </Link>
