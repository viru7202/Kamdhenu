...
export default function EditDelilveryBoy() {
                            ...
                            <div className="row">
                                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active" aria-current="page">Edit Delivery Boy</li>
                                    </ol>
                                </nav>
                                <div className="col-lg-12 col-sm-12">
                                    <div className="content-page-header">
                                        <h5>Edit Delivery Boy</h5>
                                    </div>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-3">
                                            <div className="add-form">
                                                ...
                                                {/* <Multiselect
                                                    ...
                                                    onRemove={(removedItem) => handleRemoveArea(removedItem)}
                                                    onSearch={() => { }}
                                                    onSelect={(selectedList) => handleSelectArea(selectedList)}
