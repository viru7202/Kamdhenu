...
import { ADD, UPDATE, UPLOAD } from '../../Functions/apiFunction';
...
export default function EditCategories() {
    ...
    const GET = async () => {
        ...
        try {
            ...
            console.log(subcat.data.data.title);
            setTitle(subcat.data.data.title);
    ...
    const update = async (e) => {
        ...
        const update = await UPDATE(token, url, data, navigateToPath, path, setLoader, alert);
        console.log(update);
