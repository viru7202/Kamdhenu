...
import AddCash from "./create/AddCash";
                    ...
                    <div className="content">
                        <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Cash Collection</li>
                            </ol>
                        </nav>
                        ...
                        <div className="d-flex gap-3 mt-4">
                            ...
                            {/* <div className="list-btn">
                                <ul>
                                    <li>
                                        <Link to={"/create-society"} className="btn btn-primary">
                                            <i className="fa fa-plus me-2"></i>Collect
                                        </Link>
                                    </li>
                                </ul>
                            </div> */}
                                    ...
                                    <table className="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="table-actions d-flex">
                                                        <Link className="delete-table me-2" to={'/edit-society/1'}>
                                                            <i className="fas fa-edit"></i>
                                                        </Link>
