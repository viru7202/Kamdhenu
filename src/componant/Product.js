                    ...
                    <div className="content">
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="list-btn">
                                <ul>
                                    <li>
                                        <Link to={"/create-stock"} className="btn btn-primary">
                                            <i className="fa fa-plus me-2"></i>Add Stock
                                        </Link>
                                        <Link to={"/create-products"} className="btn btn-primary mx-3">
                                    ...
                                    <table className="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="table-actions d-flex">
                                                        <Link className="delete-table me-2" to={'/edit-product/1'}>
                                                            <i className="fas fa-edit"></i>
                                                        </Link>
